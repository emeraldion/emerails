...
class Localization
{
    ...
    public static function localize($term)
    {
        ...
        return self::wrap(
            array_key_exists($term, self::$strings_table)
                ? self::$strings_table[$term]
                : $term
        );
    }
    ...
    private static function load_strings_file($lang = 'en', $controller = null)
    {
        $strings_file = $controller
            ? dirname(__FILE__) .
                "/../assets/strings/$controller/localizable-$lang.strings"
            : dirname(__FILE__) .
                "/../assets/strings/localizable-$lang.strings";
