...
<html>
	<head>
		...
		<link rel="icon" href="<?php print Emeraldion\EmeRails\Config::get('APPLICATION_ROOT'); ?>assets/images/favicon.png" type="image/png" />
		<link rel="stylesheet" type="text/css" href="<?php print Emeraldion\EmeRails\Config::get('APPLICATION_ROOT'); ?>assets/styles/styles.css" />
	</head>
	<body>
